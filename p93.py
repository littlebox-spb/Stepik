...
#             s += 1
#     rate.append([group["id_group"], s])

# print(*sorted(rate, key=lambda x: x[1]))
...
#     for car in man["cars"]:
#         s += car["price"]
#     rate.append([man["manager"]["first_name"], man["manager"]["last_name"], s])

# print(*sorted(rate, key=lambda x: x[2]))
